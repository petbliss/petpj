	...
	<table class="table table-striped table-hover" id="searchTable" >
		...
		<tbody>		
			<c:forEach items="${qlistContent}" var="dto">
				<tr>
					<td id="nid">${dto.qId}</td> 					
					<td>
						<a class="QnA_content_view" href="QnA_content_view?nId=${dto.qId}">${dto.qTitle}</a>
					</td>
					<td>${dto.qWriter}</td>
					<td>${dto.qRdate}</td>
					<td>${dto.qHit}</td>
...
<div class="container" id="boardOnly">
	...
	<a id="write" class="btn btn-outline-dark" href="QnA_write_view">글작성</a>
</div>
