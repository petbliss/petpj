...
<div class="container">
	<h3 class="text-center">FAQ작성</h3>
	<form action="fwrite" method="post">
		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
		<div class="form-group">
			<label for="uname">이름:</label>
			<input type="text" class="form-control" id="fName" placeholder="Enter email"
				name="fName" required value="${fName}">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<textarea class="form-control" id="content" placeholder="Enter Content"
				name="fContent" rows="10" required></textarea>
		</div>		
		<button type="submit" class="btn btn-outline-dark">작성</button>
		 &nbsp;&nbsp; <a href="FAQ" class="btn btn-outline-info">목록</a>
	</form>
</div>
