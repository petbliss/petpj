	...
	<form id="frm1" name="frm1" method="post" action="login">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="pid" 
				placeholder="아이디 입력" id="uId" required/>
		</div>
		<div class="form-group">
		...
		<!-- social로그인 google,naver,kakao예정 -->
 		...
 		<a id="nlog" href="${naver_url}" class="btn btn-primary">
 			<img width="90"  src="images/naverid_login_button_short.png"/>
 		</a>&nbsp;&nbsp;
		...
		<a href="find_id" class="btn"><i class="fa fa-user fa-lg position-left"></i>아이디찾기</a>
		<a href="find_pw" class="btn"><i class="fa fa-lock fa-lg position-left"></i>비밀번호 찾기</a>
	</form>
</div>
<script>
$(document).ready(function(){
	...
	<c:choose>
		...
		<c:when test="${not empty logout}"> //logout성겅시
			$("#div1").text("Logout 성공");
		</c:when>
