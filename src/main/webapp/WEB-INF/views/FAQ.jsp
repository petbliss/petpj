...
$(document).ready(function(){
	...
	$("#fwrite").click(function(event){
		...
		$.ajax({
			...
			error : function() {
				alert("FAQ_write_view시 에러 발생");
			}
		});
	});
	
	//내용보기
	$(".notice_content_view").click(function(event){
		$("#searchForm").css("visibility","hidden");
	...
	window.pagObj = $('#pagination').twbsPagination({		
		...
		onPageClick : function (event, page) {
			...
			$(".page-link").on("click",function(event){
				...
				var pageNo1 = peo.innerHTML;	//페이지 번호
				var purl;
				if(pageNo1 != "First" && pageNo1 != "Previous" && pageNo1 != "Next" && pageNo1 != "Last"){
					purl = "FAQ_plist?pageNo1=" + pageNo1;
				}
				else {
					return;
				}
