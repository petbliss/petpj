...
<div class="container">
	<h3 class="text-center">공지사항 내용보기 및 수정, 삭제</h3>
	<form action="modify" method="post">
		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
			<div class="form-group">
				<label for="uId">번호</label>
				<input type="text" class="form-control" id="uId" name="nId"
					value="${notice_content_view.nId}" readonly/>
			</div>
			<div class="form-group">
				<label for="hit">히트수</label>
				<input type="text" class="form-control" id="hit" value="${notice_content_view.nHit}" readonly/>
			</div>
			<div class="form-group">
				<label for="uwriter">작성자</label>
				<input type="text" class="form-control" id="uwriter" name="nWriter" 
					value="${notice_content_view.nWriter}"/>
			</div>
			<div class="form-group">
				<label for="title">제목:</label>
				<input type="text" class="form-control" id="title" name="nTitle" 
					value="${notice_content_view.nTitle}">
			</div>
			<div class="form-group">
				<label for="content">내용:</label>
				<textarea class="form-control" id="content" placeholder="Enter Content"
					name="nContent" rows="10">
						${notice_content_view.nContent}
				</textarea>
			</div>
			<!--  
			...
			&nbsp;&nbsp; <a href="notice" class="btn btn-dark">목록보기</a>
			&nbsp;&nbsp; <a href="delete?nId=${notice_content_view.nId}" id="del"
